...
--
-- Name: authors; Type: TABLE; Schema: public; Owner: tahsharaboochee
--
...
ALTER TABLE public.authors OWNER TO tahsharaboochee;

--
-- Name: authors_id_seq; Type: SEQUENCE; Schema: public; Owner: tahsharaboochee
--
...
ALTER TABLE public.authors_id_seq OWNER TO tahsharaboochee;

--
-- Name: authors_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tahsharaboochee
--
...
--
-- Name: booklist_books; Type: TABLE; Schema: public; Owner: tahsharaboochee
--

CREATE TABLE public.booklist_books (
    book_id integer,
    date_book_added timestamp without time zone DEFAULT now(),
    booklist_id integer
);


ALTER TABLE public.booklist_books OWNER TO tahsharaboochee;

--
-- Name: booklists; Type: TABLE; Schema: public; Owner: tahsharaboochee
--

CREATE TABLE public.booklists (
    list_id integer NOT NULL,
    list_name text,
    date_created timestamp without time zone DEFAULT '2020-03-26 14:12:36.506941'::timestamp without time zone,
    list_creator character varying(30)
);


ALTER TABLE public.booklists OWNER TO tahsharaboochee;

--
-- Name: booklists_list_id_seq; Type: SEQUENCE; Schema: public; Owner: tahsharaboochee
--

CREATE SEQUENCE public.booklists_list_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.booklists_list_id_seq OWNER TO tahsharaboochee;

--
-- Name: booklists_list_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tahsharaboochee
--

ALTER SEQUENCE public.booklists_list_id_seq OWNED BY public.booklists.list_id;


--
-- Name: books; Type: TABLE; Schema: public; Owner: tahsharaboochee
--
...
ALTER TABLE public.books OWNER TO tahsharaboochee;

--
-- Name: books_id_seq; Type: SEQUENCE; Schema: public; Owner: tahsharaboochee
--
...
ALTER TABLE public.books_id_seq OWNER TO tahsharaboochee;

--
-- Name: books_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tahsharaboochee
--
...
--
-- Name: authors id; Type: DEFAULT; Schema: public; Owner: tahsharaboochee
--
...
--
-- Name: booklists list_id; Type: DEFAULT; Schema: public; Owner: tahsharaboochee
--

ALTER TABLE ONLY public.booklists ALTER COLUMN list_id SET DEFAULT nextval('public.booklists_list_id_seq'::regclass);


--
-- Name: books id; Type: DEFAULT; Schema: public; Owner: tahsharaboochee
--
...
--
-- Data for Name: authors; Type: TABLE DATA; Schema: public; Owner: tahsharaboochee
--
...
--
-- Data for Name: booklist_books; Type: TABLE DATA; Schema: public; Owner: tahsharaboochee
--

COPY public.booklist_books (book_id, date_book_added, booklist_id) FROM stdin;
9	2020-03-26 14:22:20.730578	3
3	2020-03-26 14:22:20.730578	3
6	2020-03-26 14:22:20.730578	3
4	2020-03-26 14:22:20.730578	2
7	2020-03-26 14:22:20.730578	3
2	2020-04-06 12:00:09.024801	1
8	2020-04-10 15:28:26.262079	2
5	2020-04-10 15:27:38.208409	2
1	2020-04-10 18:32:38.759716	2
1	2020-04-10 18:37:27.517005	1
\.


--
-- Data for Name: booklists; Type: TABLE DATA; Schema: public; Owner: tahsharaboochee
--

COPY public.booklists (list_id, list_name, date_created, list_creator) FROM stdin;
1	Best Childrens Books	2020-03-26 14:12:36.506941	Bo
2	Best Books Ever	2020-03-26 14:12:36.506941	Amy
3	Books That Should Be Made Into Movies	2020-03-26 14:12:36.506941	Lee
\.


--
-- Data for Name: books; Type: TABLE DATA; Schema: public; Owner: tahsharaboochee
--
...
--
-- Name: authors_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tahsharaboochee
--
...
--
-- Name: booklists_list_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tahsharaboochee
--

SELECT pg_catalog.setval('public.booklists_list_id_seq', 3, true);


--
-- Name: books_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tahsharaboochee
--
...
--
-- Name: authors authors_pkey; Type: CONSTRAINT; Schema: public; Owner: tahsharaboochee
--
...
--
-- Name: booklists booklists_pkey; Type: CONSTRAINT; Schema: public; Owner: tahsharaboochee
--

ALTER TABLE ONLY public.booklists
    ADD CONSTRAINT booklists_pkey PRIMARY KEY (list_id);


--
-- Name: books books_pkey; Type: CONSTRAINT; Schema: public; Owner: tahsharaboochee
--
...
--
-- Name: booklist_books booklist_books_book_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tahsharaboochee
--

ALTER TABLE ONLY public.booklist_books
    ADD CONSTRAINT booklist_books_book_id_fkey FOREIGN KEY (book_id) REFERENCES public.books(id) ON DELETE CASCADE;


--
-- Name: booklist_books booklist_books_booklist_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tahsharaboochee
--

ALTER TABLE ONLY public.booklist_books
    ADD CONSTRAINT booklist_books_booklist_id_fkey FOREIGN KEY (booklist_id) REFERENCES public.booklists(list_id) ON DELETE CASCADE;


--
-- Name: books books_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tahsharaboochee
--
